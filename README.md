# Plotly-Challenge
Homework 15 for UMN Data Visualization and Analytics bootcamp
...
- static folder containing:
    - A js folder with an apps.js file for the script
- A .DS_Store
- This readme file
- index.html for the html script
- samples.json which contains the data evaluated in this assignment
